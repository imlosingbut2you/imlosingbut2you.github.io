    ...
    const testPosts = [
        ...
        },
        {
            ...
            comments: [
                {
                    userId: '108',
                    text: 'Muhteşem bir kare! 👏',
                    timestamp: new Date(Date.now() - 3900).toISOString()
                }
            ]
        },
        {
            ...
            type: 'note',
            userId: '108', // Nida
            text: 'Bugün harika bir kitap bitirdim! 📚',
